...
const GalleryPhotos = (admin) => {
  ...
  const { images, loading } = useFetchGalleryImages(); // Assuming fetchImages fetches the images again
  ...
  return (
    <>
      ...
      <Modal isOpen={addImg} onClose={closeModal}>
        <UploadImages onClose={closeModal} setAddImg={setAddImg} />
      </Modal>
      <Modal isOpen={deleteImg} onClose={closeModal}>
