      ...
      <section className="bg-gray-50 dark:bg-gray-900">
        <div className="py-20 bg-gray-50 pt-14">
          <div className="container mx-auto px-6 md:px-12 xl:px-32">
            ...
            <div className="blogs-body grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className={styles.iframeContainer}>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Hikma Online</h3>
                <iframe
                  src="https://hikmaonline.in/"
                  title="Hikma Online"
                  className={`w-full h-96 md:h-[calc(100vh-200px)] border-2 border-gray-200 dark:border-gray-700 rounded-lg ${styles.scrollable}`}
                ></iframe>
              </div>
              <div className={styles.iframeContainer}>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Lawhat</h3>
                <iframe
                  src="https://www.lawhat.in/"
                  title="Law Hat"
                  className={`w-full h-96 md:h-[calc(100vh-200px)] border-2 border-gray-200 dark:border-gray-700 rounded-lg ${styles.scrollable}`}
                ></iframe>
              </div>
