    ...
    <>
      <footer className="foot-footer bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="grid">
            <div className="grid grid-cols-1 ft-head-title">
              <h3>Get the latest DUIDC news delivered to you inbox</h3>
            </div>
            <div className=" ft-input-sub">
              <div className="ft-in">
                <input
                  type="text"
                  className="ft-input"
          ...
          <hr className="foot-hr my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
          <div className="md:flex ft-foot md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="foot-p">
                DUIDC transforms lives through accessible, student-centered,
                high-quality education and meets learners’ needs for a lifetime.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="foot-h3 mb-6 text-sm text-gray-900 dark:text-white">
                  About
                </h2>
              ...
              <div>
                <h2 className="foot-h3 mb-6 text-sm font-semibold text-gray-900 dark:text-white">
                  Links
                </h2>
          ...
          <div className="sm:flex mt-6 sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a
                href="#"
                className="foot-icons text-gray-500 hover:text-gray-900 dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="#"
                className="foot-icons text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
